          ...
          <div style={{padding:'56px 20px 32px',background:'var(--black)',color:'var(--white)'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'16px'}}>
              {[
                ...
                {num:'02', title:'Deficiencies & What Tests You Need', desc:"Most women are deficient and don't know it. We break down which tests to request and what your results mean for your transformation.", pdf:'/pdfs/testing_guide.pdf', dl:'Deficiencies_And_Tests_Guide.pdf', cover:'/videos/covers/testing_cover.jpg'},
                {num:'03', title:'Body Functions + Peptides & Herbs', desc:'Understand how your metabolism, liver, and gut work together — plus peptides and herbs that can amplify your results.', pdf:'/pdfs/body_functions_guide.pdf', dl:'Body_Functions_Guide.pdf', cover:'/videos/covers/body_functions_cover.jpg'},
                {num:'04', title:'Your First Order & Why It Works', desc:"See what's in your first order, how the booster works, and the protocol to follow while you wait on test results.", pdf:'/pdfs/protocol_guide.pdf', dl:'Your_First_Order_And_Why_It_Works.pdf', cover:'/videos/covers/first_order_cover.jpg'},
              ].map(v => (
