        ...
        <div style={{ width:'100%', maxWidth:'420px', margin:'0 auto', background:'var(--cream)', border:'1px solid var(--border)', borderRadius:'20px', overflow:'hidden' }}>
          ...
          <div style={{padding:'56px 20px 32px',background:'var(--black)',color:'var(--white)'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'16px'}}>
              {[
                {num:'01', title:'Know Your Blood Type', desc:'Your blood type determines how your body processes food, stores fat, and responds to supplements. This is where your reset starts.', pdf:'/pdfs/blood_type_guide.pdf', dl:'Know_Your_Blood_Type_Reset_Guide.pdf'},
